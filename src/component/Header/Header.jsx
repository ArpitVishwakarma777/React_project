...
export default function Header() {
    return (
      <div>
  <NavLink className="navbar mb-0 navbar-expand-lg navbar-light bg-white  ">
    <div className="container-fluid box ">
      ...
      <div className="collapse navbar-collapse mx-4 nav" id="navbarSupportedContent">
        <ul className="navbar-nav me-lg-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
            <Link className="nav-link" href="#">Manu</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" href="#">About</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" href="#" tabIndex={-1}>Contect Us</Link>
          </li>
        </ul>
